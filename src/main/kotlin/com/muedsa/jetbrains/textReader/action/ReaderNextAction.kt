...
class ReaderNextAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val text = textReaderService.nextContent(settings.chapterTitleLineLengthLimit) ?: return
        when (settings.singleLineTextShowType) {
            ReaderLineShowType.EDITOR_BACKGROUND -> e.getData(PlatformDataKeys.EDITOR)?.let {
